...
@SpringBootTest
class ObjectInfoProcessWithOutNavigationInformationTest {
    ...
    @DisplayName("выполнить сценарий обновления транспортных единиц")
    @Test
    void shouldCorrectPathUpdateTransportUnit() {
